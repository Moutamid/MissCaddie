...
public class GoflerChatListAdapter extends RecyclerView.Adapter<GoflerChatListAdapter.IncomingMessageVH> {

    Context context;
    ArrayList<Conversation> list;

    public GoflerChatListAdapter(Context context, ArrayList<Conversation> list) {
    ...
    public void onBindViewHolder(@NonNull IncomingMessageVH holder, int position) {
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference()
                .child("Caddie").child(model.getChatWithId());
