...
public class ImageSliderCaddieAdapter extends SliderViewAdapter<ImageSliderCaddieAdapter.SliderAdapterVH> {

    private Context context;
    private List<SliderItem> mSliderItems;

    public ImageSliderCaddieAdapter(Context context, List<SliderItem> mSliderItems) {
